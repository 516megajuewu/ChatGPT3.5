    ...
    sendHeartbeat() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.ws && this.ws.readyState == ws_1.WebSocket.OPEN) {
                ...
                let ssml = '<speak xmlns="http://www.w3.org/2001/10/synthesis" xmlns:mstts="http://www.w3.org/2001/mstts" xmlns:emo="http://www.w3.org/2009/10/emotionml" version="1.0" xml:lang="en-US"><voice name="en-US-JennyNeural"><prosody rate="0%" pitch="0%">滴答</prosody></voice></speak>';
                let ssmlMessage = `X-Timestamp:${Date()}\r\n` +
                    ...
                    ssml;
                yield this.ws.ping();
                yield this.ws.send(ssmlMessage, (ssmlError) => { });
            }
        });
    }
    connect() {
        return __awaiter(this, void 0, void 0, function* () {
            const connectionId = (0, crypto_1.randomBytes)(16).toString('hex').toUpperCase();
